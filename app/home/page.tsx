    ...
    <>
      ...
      <div className="p-3">
        ...
        <div className="flex justify-start items-start max-sm:mt-2">
          ...
          <ul className={`${toggleBtn ? 'pointer-events-auto opacity-100 translate-x-0 scale-95 ' : 'pointer-events-none  opacity-0 translate-x-full scale-110'} transform transition-all duration-500 ease-in-out flex justify-start items-start flex-col gap-8 text-base p-5 mt-12 w-60 h-96 py-10 px-2 rounded-lg absolute font-pelak bg-white shadow-lg`}>
            <li onClick={() => setActiveTab(<CreateTask handelBack={(e: unknown) => res(e)} />)} className="cursor-pointer">اضافه کردن تسک ✒️</li>
            <li className="cursor-pointer">اضافه کردن دسته بندی ✏️</li>
