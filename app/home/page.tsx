    ...
    <>
      ...
      <div className="p-3 max-sm:p-0">
        ...
        <div className="flex justify-start items-start max-sm:mt-2">
          ...
          <ul className={`${toggleBtn ? 'pointer-events-auto opacity-100 translate-x-0 scale-95 ' : 'pointer-events-none  opacity-0 translate-x-full scale-110'} transform z-30 max-sm:items-center transition-all duration-500 ease-in-out flex justify-start items-center flex-col gap-8 text-base p-5 mt-12 w-60 max-sm:w-full h-72 py-9 px-2 rounded-lg absolute font-pelak bg-white border-2`}>
